...
4. Immediately validate the scaffolded skill (run quick_validate.py) to catch invalid frontmatter or template issues before further editing.
5. Edit the skill (implement resources and write SKILL.md)
6. Re-run quick_validate.py after changes to SKILL.md or agents/openai.yaml.

...
Page PDFs are Prince of `/_prince/…` HTML, not Chrome “print this page.” The print template inlines its own CSS (`single.print.html`). Shortcodes share `.Content` with the site, so markup has to survive both.

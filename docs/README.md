...
| [Product goals](goals.md) | Admin UI, Word ingest, Crossref, Algolia, SEO/JSON-LD/AI, Tailwind, sidecar data; near-term tracking + JSON-LD hygiene; AMP / Discourse / UA defunct |
